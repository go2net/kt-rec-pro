...
#define LCD_BACK_LIGHT_ON_LEVEL_HIGH

#define EXCHANGE_AUX_CHANNEL

#define HOT_KEY_SELECT_DEVICE
#define AUX_DETECT_FUNC
#define AUX_DETECT_SHARE_IIC_GPIO
#define AUX_DETECT_USE_P07

#define REC_PLAY_KEY_BREAK_POINT
#define FM_FREQ_NUM_KEY_INPUT
#define AUTO_PLAY_RADIO_REC_FILE
#define AUTO_PLAY_RADIO_REC_FILE_AT_ONCE
...
#define NEXT_PREV_KEY_NO_RESPONSE_SCAN_ALL
