...
#elif defined(NEW_FT_LCD_780_MODULE)||defined(JF_168_LCD_MODULE_NEW_BOARD)||defined(NEW_RM_LCD_2930_MODULE)
...
#elif defined(NEW_FP_LCD_211_MODULE)||defined(LCD_DRV_5_COM_8_SEG)
#define   com_init()      	P3PU |= (0x1F);P3PD |= (0x1F)
#define   close_com(n)    	com_init();P3DIR |= (0x1F);P3DIR &= ~(1<<(n))
...
#define SW_2_DEV_MASK	0x0080
#define F_SW_2_DEV		(lcd_buff[4])	
...
#define AM_KHZ_MASK	0x0008
#define F_KHZ_DEV		(lcd_buff[3])	

#define SW_MHZ_MASK	0x0002
#define F_SW_MHZ_DEV	(lcd_buff[3])	

#define FM_P1_MASK		0x0040
#define F_P1_DEV		(lcd_buff[4])	

#define SW_P2_MASK		0x0004
...
#define PLAY_MASK		0x0000
#define PAUSE_MASK		0x0000
#define F_PLAY_DEV		(lcd_buff[3])
#define F_PAUSE_DEV		(lcd_buff[3])
...
#define F_POINTS		(lcd_buff[2])	

#define FM_MHZ_MASK	0x0100
#define F_MHZ_DEV		(lcd_buff[4])	

#define AM_KHZ_MASK	0x0100
#define F_KHZ_DEV		(lcd_buff[0])	

#define SW_MHZ_MASK	0x0100
#define F_SW_MHZ_DEV	(lcd_buff[4])	

#define FM_P1_MASK		0x0002
#define F_P1_DEV		(lcd_buff[3])	

#define SW_P2_MASK		0x0008
#define F_P2_DEV		(lcd_buff[3])	
...
#define REP_ALL_MASK	0x0004
#define REP_ONE_MASK	0x0014
#define F_REP_ALL		(lcd_buff[3])
#define F_REP_ONE 		(lcd_buff[3])

#define PLAY_MASK		0x0040
#define PAUSE_MASK		0x0080
#define F_PLAY_DEV		(lcd_buff[3])
#define F_PAUSE_DEV		(lcd_buff[3])
...
#define FIGURE_NUM	4
#elif defined(JF_168_LCD_MODULE_NEW_BOARD)
...
#elif defined(JK_HT_998_LCD_MODULE)
...
#elif defined(JK_JF_933_LCD_MODULE)
...
#define BATTERY_MASK	0x0040
#define F_BAT_ICON_BUF	(lcd_buff[4])	
